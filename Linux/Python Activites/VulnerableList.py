...
# Create a loop using range() that moves through only the first five IP addresses and prints them in order to the screen with their rank
...
# Create a loop using enumerate() that goes through all of the IP addresses and prints out the vulnerability ranking for each one
